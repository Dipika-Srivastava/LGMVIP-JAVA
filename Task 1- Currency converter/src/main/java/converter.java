...
public class converter extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setFont(new java.awt.Font("Engravers MT", 3, 12)); // NOI18N
        jLabel2.setText("From");

        jLabel3.setFont(new java.awt.Font("Engravers MT", 3, 12)); // NOI18N
        jLabel3.setText("To");

        txtfrom.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "USD", "INR" }));

        txtto.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Indian Currency", "Bhutan Currency", "USD", " " }));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(txtto, 0, 206, Short.MAX_VALUE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if("USD".equals(txtfrom.getSelectedItem().toString())  && "Indian Currency".equals(txtto.getSelectedItem().toString()))
        {
            tot = amount*82.55;
            JOptionPane.showMessageDialog(this,"Amount is " + tot.toString());
        }
        else if("USD".equals(txtfrom.getSelectedItem().toString()) && "Bhutan Currency".equals(txtto.getSelectedItem().toString()))
        {
            tot = amount*82.85;
              JOptionPane.showMessageDialog(this,"Amount is " + tot.toString());
        }
         else if("INR".equals(txtfrom.getSelectedItem().toString()) && "USD".equals(txtto.getSelectedItem().toString())){
              tot = amount*0.012;
              JOptionPane.showMessageDialog(this,"Amount is " + tot.toString());
